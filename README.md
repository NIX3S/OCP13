...
![Chess Agent IA](https://img.shields.io/badge/Status-%20Production-blue?style=for-the-badge&logo=docker&logoColor=white) [![GitHub](https://img.shields.io/github/license/NIX3S/OCP13?logo=github)](https://github.com/NIX3S/OCP13)

**Agent d'analyse d'échecs intelligent** avec **détection d'ouvertures**, **RAG Wikichess**, **YouTube tutoriels**, **Stockfish** et **échiquier Angular interactif**.
...
| **Drag & Drop** coups | **Stockfish évaluation** temps réel | **Milvus vectorDB** + **Qwen3** | **Cache intelligent** 24h |
...
|----------|-------------|---------|
| `GET /api/v1/analyze/{fen}` | **Analyse complète** position | `/analyze/rnbqkbnr...` |
| `GET /vector-search/{opening}` | **RAG Wikichess** similaire | `/vector-search/Sicilian` |
| `GET /healthcheck` | **Status services** | Cache + YouTube |
...
| [@NIX3S](https://github.com/NIX3S) |  
|---|---|
| **Full Stack + Debug RAG + Git** |

---

[![stars](https://img.shields.io/github/stars/NIX3S/OCP13?style=social)](https://github.com/NIX3S/OCP13) [![forks](https://img.shields.io/github/forks/NIX3S/OCP13?style=social)](https://github.com/NIX3S/OCP13)
